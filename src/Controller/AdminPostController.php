...
final class AdminPostController extends AbstractController
{
    ...
    #[Route('/{id}', name: 'app_admin_post_show', methods: ['GET'], requirements: ['id' => '\d+'])]
    ...
    #[Route('/{id}/edit', name: 'app_admin_post_edit', methods: ['GET', 'POST'], requirements: ['id' => '\d+'])]
    ...
    #[Route('/{id}/delete', name: 'app_admin_post_delete', methods: ['POST'], requirements: ['id' => '\d+'])]
